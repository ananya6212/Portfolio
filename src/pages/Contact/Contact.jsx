...
export default function Contact() {
  ...
  const handleSubmit = async (e) => {
    ...
    form.append("access_key", "bf742bdf-5e61-4d07-9a2f-f3b645e44a73"); // Replace with your Web3Forms access key
              ...
              <div className="space-y-6">
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">anansharma154@gmail.com</p>
                  </div>
                </div>
                ...
                <div className="flex items-center space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Turner Road, DehraDun</p>
                  </div>
                </div>
              </div>
            </div>
